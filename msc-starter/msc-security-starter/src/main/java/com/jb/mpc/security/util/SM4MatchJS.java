...
*@since 1.6
*/
public class SM4MatchJS {
	private static SM4MatchJS sm4 = null;
	...
	public static SM4MatchJS getInstance() {
		if (sm4 == null)
			sm4 = new SM4MatchJS();
		String partKye = SM2_SM4_Cache.getPrivateKeyPart("SM4KEY");
		sm4.secretKey = "JeF8U9MHF" + partKye;
		return sm4;
	}
	...
	public String encode(String input) throws IOException{
		return encode(input,this.secretKey);
	}
	...
	public String decode(String input) throws IOException{
		...
		return decode(input,this.secretKey);
	}
	...
	public static void main(String[] args) throws IOException {
		String string = "nfdwmpc_504";
		System.out.println("明文："+string);
		String s = new SM4MatchJS().encode(string, "useProInfo");
		System.out.println("加密密文："+s);//S8u8cV6S5Wem2e9YvzCxSg==
		String j = new SM4MatchJS().decode(s, "useProInfo");
		System.out.println("解密："+j);
		s = new SM4MatchJS().encode(j, "useProInfo");
		System.out.println("加密密文："+s);
		 string = "123456";
		System.out.println("明文："+string);
		 s = new SM4MatchJS().encode(string, "useProInfo");
		System.out.println("加密密文："+s);//rYdjrj3T2B1RbY3KdG2jLA==
		 j = new SM4MatchJS().decode(s, "useProInfo");
		System.out.println("解密："+j);
		s = new SM4MatchJS().encode(j, "useProInfo");
		System.out.println("加密密文："+s);
	}
